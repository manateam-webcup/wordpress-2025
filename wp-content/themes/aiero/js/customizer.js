...
function aiero_customizer_dependancy() {
...
function aiero_customizer_repeater_uniqid(prefix, more_entropy) {
...
function aiero_customizer_repeater_refresh_social_icons(th) {
    ...
    th.find('.customizer-repeater-social-repeater-container').each(function () {
        ...
        if (!id) {
            id = 'customizer-repeater-social-repeater-' + aiero_customizer_repeater_uniqid();
    ...
    aiero_customizer_repeater_refresh_general_control_values();
}

function aiero_customizer_repeater_refresh_general_control_values() {
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            if (!id) {
                id = 'social-repeater-' + aiero_customizer_repeater_uniqid();
...
function aiero_get_resolution_value($element) {
    var selected_values = {
...
function aiero_get_dimensions_value($element) {
    var selected_values = {
...
function aiero_get_font_value($element) {
    var selected_values = {
...
function aiero_ctype_digit(text) {
...
function aiero_escape_html(string) {
...
jQuery(document).ready(function($) {
    ...
    */
    $('.customize-control-resolution input[type="number"]').on('change', function() {
        aiero_get_resolution_value( $(this).parents('.customize-control-resolution') );
    });
    ...
    */
    $('.customize-control-dimensions select, .customize-control-dimensions input[type="number"]').on('change', function() {
        aiero_get_dimensions_value( $(this).parents('.customize-control-dimensions') );
    });

    /**
     * Google Font Custom Control
     */
    $('.aiero-google-fonts-list').on('change', function () {
        var elementWeightStyle = $(this).parent().parent().find('.aiero-google-font-styles');
        var elementSubset = $(this).parent().parent().find('.aiero-google-font-subset');
        var elementWeight = $(this).parent().parent().find('.aiero-google-font-weight');
        ...
        $.each(gflist[index].weights, function (val, text) {
            ...
            text = $.trim(text);
            if (optval === selectedWeight && aiero_ctype_digit(optval)) {
                elementWeightStyle.append(
                    $('<option></option>').val(optval).html(text).attr('selected', 'selected')
                ).val(optval).change();
            } else if (aiero_ctype_digit(optval)) {
                elementWeightStyle.append(
                    $('<option></option>').val(optval).html(text)
                );
            }
    ...
    $('.customize-control-google-font select, .customize-control-google-font input[type="number"]').on('change', function() {
        aiero_get_font_value( $(this).parents('.customize-control-google-font') );
    });
...
jQuery(document).ready(function() {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        var id = 'customizer-repeater-' + aiero_customizer_repeater_uniqid();
