...
class Aiero_Audio_Listing_Widget extends Widget_Base {

    public function get_name() {
        return 'aiero_audio_listing';
    }

    public function get_title() {
        return esc_html__('Audio Listing', 'aiero_plugin');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_content',
            [
                'label' => esc_html__('Audio Listing', 'aiero_plugin')
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options'   => [
                    ...
                    'columns'   => esc_html__('Columns', 'aiero_plugin')
                ]
            ]
        );
        ...
        $repeater->add_control(
            'audio',
            [
                'label'     => esc_html__('Audio', 'aiero_plugin'),
        ...
        $this->add_control(
            'hide_icon',
            [
                'label'         => esc_html__('Hide Audio Icon', 'aiero_plugin'),
        ...
        $this->add_control(
            'title_position',
            [
                'label' => esc_html__( 'Title Position', 'aiero_plugin' ),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .aiero-audio-listing' => 'margin: calc(-{{SIZE}}{{UNIT}}/2);',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .aiero-audio-listing' => 'margin-top: calc(-{{SIZE}}{{UNIT}}/2); margin-bottom: calc(-{{SIZE}}{{UNIT}}/2);',
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__('Image and Icon Settings', 'aiero_plugin'),
                'tab'       => Controls_Manager::TAB_STYLE
            ]
        );
        ...
        $this->add_responsive_control(
            'icon_spacing',
            [
                'label'     => esc_html__('Space After Icon', 'aiero_plugin'),
                'type'      => Controls_Manager::SLIDER,
                'size_units' => [ 'px', 'em', '%' ],
                'range'     => [
                    'px'        => [
        ...
        $this->add_responsive_control(
            'width',
            [
                'label'             => esc_html__( 'Image Width', 'aiero_plugin' ),
                'type'              => Controls_Manager::SLIDER,
                'default'           => [
                    'unit'  => '%',
                ],
    ...
    protected function render() {
        ...
        $wrapper_class      = 'aiero-audio-listing' . ( !empty($view_type) ? ' view-' . $view_type : ' view-inline' );
