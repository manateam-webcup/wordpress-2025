...
class Aiero_Wpforms_Widget extends Widget_Base {

    public function get_name() {
        return 'aiero_wpforms';
    }

    public function get_title() {
        return esc_html__('WPForms', 'aiero_plugin');
    }
    ...
    protected function register_controls() {
        ...
        $form_list_default = [
            'default' => esc_html__('Select your form', 'aiero_plugin')
        ];
        $form_list = [];
        if ( !empty( $forms ) ) {
            ...
            $form_list['default'] = esc_html__('No forms', 'aiero_plugin');
        }
        $this->add_control(
            'form',
            [
                'label'   => esc_html__('Form', 'aiero_plugin'),
        ...
        $this->add_control(
            'add_name',
            [
                'label' => esc_html__('Display form name', 'aiero_plugin'),
        ...
        $this->add_control(
            'add_description',
            [
                'label' => esc_html__('Display form description', 'aiero_plugin'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'label_off' => esc_html__('No', 'aiero_plugin'),
                'label_on' => esc_html__('Yes', 'aiero_plugin')
        ...
        $this->add_responsive_control(
            'submit_spacing',
            [
                'label' => esc_html__( 'Space Before Submit Button', 'aiero_plugin' ),
        ...
        $this->add_responsive_control(
            'textfield_height',
            [
                'label' => esc_html__( 'Text Field Height', 'aiero_plugin' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', 'em', 'rem'],
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label'         => esc_html__('Form Header Settings', 'aiero_plugin'),
                'tab'           => Controls_Manager::TAB_STYLE,
                'conditions'    => [
                    'relation'  => 'or',
                    'terms'     => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => esc_html__('Form Name Typography', 'aiero_plugin'),
        ...
        $this->add_control(
            'form_name_color',
            [
                'label'     => esc_html__('Form Name Color', 'aiero_plugin'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => esc_html__('Form Description Typography', 'aiero_plugin'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Form Description Color', 'aiero_plugin'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Field Focus Placeholder Color', 'aiero_plugin'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Field Focus Border Color', 'aiero_plugin'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'required_color',
            [
                'label'     => esc_html__('Required Field Sign Color', 'aiero_plugin'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => esc_html__('Field Description Typography', 'aiero_plugin'),
        ...
        $this->add_control(
            'description_color',
            [
                'label'     => esc_html__('Field Description Color', 'aiero_plugin'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function render() {
        ...
        // ------------------------------------ //
        ?>
        <div class="aiero-wpforms-widget">
            <?php
                if ( !empty($title) ) {
                    echo '<' . esc_html($title_tag) . ' class="wpforms-widget-heading aiero-heading"><span class="aiero-heading-content">' . esc_html($title) . '</span></' . esc_html($title_tag) . '>';
                }
                if ( !empty($form_id) ) {
