...
class Aiero_Custom_Menu_Widget extends Widget_Base {

    public function get_name() {
        return 'aiero_custom_menu';
    }

    public function get_title() {
        return esc_html__('Custom Menu', 'aiero_plugin');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_content',
            [
                'label' => esc_html__('Custom Menu', 'aiero_plugin')
            ]
        );
        ...
        $repeater->add_control(
            'title',
            [
                'label'         => esc_html__('Navigation Label', 'aiero_plugin'),
                'type'          => Controls_Manager::TEXT,
                'placeholder'   => esc_html__('Enter Label Text', 'aiero_plugin')
            ]
        );
        ...
        $this->add_control(
            'items',
            [
                'label'         => esc_html__('Menu Items', 'aiero_plugin'),
