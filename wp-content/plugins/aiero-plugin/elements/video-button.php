...
class Aiero_Video_Button_Widget extends Widget_Base {

    public function get_name() {
        return 'aiero_video_button';
    }

    public function get_title() {
        return esc_html__('Video Button', 'aiero_plugin');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_content',
            [
                'label' => esc_html__('Video', 'aiero_plugin')
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Play video', 'aiero_plugin'),
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .aiero_video_button_container' => 'text-align: {{VALUE}};',
                ],
                'prefix_class' => 'aiero-video-button-alignment%s-'
            ]
        );
        ...
        $this->add_control(
            'hide_icon',
            [
                'label'     => esc_html__( 'Hide Icon', 'aiero_plugin' ),
                'type'      => Controls_Manager::SWITCHER,
                'default'       => '',
                'return_value'  => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'label_on'      => esc_html__('Yes', 'aiero_plugin'),
                'separator'     => 'before',
                'prefix_class'  => 'aiero-video-button-decoration-'
            ]
        );
        ...
        $this->start_controls_section(
            'section_settings',
            [
                'label' => esc_html__('Video Button Settings', 'aiero_plugin'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => ['px', '%'],
                'selectors'     => [
                    '{{WRAPPER}} .aiero_video_button_widget .elementor-custom-embed-play' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            'icon_button_size',
            [
                'label' => esc_html__('Trigger Button Size', 'aiero_plugin'),
                ...
                'selectors' => [
                    '{{WRAPPER}} .aiero_video_button_widget .icon-play-wrapper' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}};',
                ],
                'separator' => 'before'
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .aiero_video_button_widget .eicon-play' => 'font-size: {{SIZE}}{{UNIT}};'
                ]
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .aiero_button_text'
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'fields_options' => [
                    'background' => [
                        'label' => esc_html__( 'Button Background Image', 'aiero_plugin' )
                    ]                    
                ],
                'exclude' => ['color'],
                'types' => [ 'classic' ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units'    => ['px', '%'],
                'selectors'     => [
                    '{{WRAPPER}} .aiero_button_text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ]
            ]
        );
            ...
            $this->start_controls_tab(
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .aiero_video_button_widget .eicon-play' => 'color: {{VALUE}};'
                        ]
                    ]
                );
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'type' => Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .aiero_video_button_widget .icon-play-wrapper:before' => 'border-color: {{VALUE}};'
                        ]
                    ]
                );
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'type' => Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .aiero_video_button_widget .icon-play-wrapper' => 'background-color: {{VALUE}};'
                        ]
                    ]
                );
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'type' => Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .aiero_button_text' => 'color: {{VALUE}};'
                        ]
                    ]
                );
                ...
                $this->add_control(
                    ...
                    [   
                        ...
                        'selectors' => [
                            ...
                            '{{WRAPPER}}.aiero-video-button-decoration-on .elementor-custom-embed-image-overlay:before, {{WRAPPER}}.aiero-video-button-decoration-on .elementor-custom-embed-image-overlay:after' => 'box-shadow: 0 20px 0 0 {{VALUE}};'
                        ]
                    ]
                );
            ...
            $this->start_controls_tab(
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'type' => Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .aiero_video_button_widget .elementor-custom-embed-play:hover .icon-play-wrapper:before' => 'border-color: {{VALUE}};'
                        ]
                    ]
                );
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'type' => Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .aiero_video_button_widget .elementor-custom-embed-play:hover .icon-play-wrapper' => 'background-color: {{VALUE}};'
                        ]
                    ]
                );
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'type' => Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}} .elementor-custom-embed-play:hover .aiero_button_text' => 'color: {{VALUE}};'
                        ]
                    ]
                );
                ...
                $this->add_control(
                    'button_bg_hover',
                    [   
                        'label' => esc_html__('Button Background Hover Color', 'aiero_plugin'),
                        'type' => Controls_Manager::COLOR,
                        'selectors' => [
                            '{{WRAPPER}}:not(.aiero-video-button-decoration-on) .elementor-custom-embed-play:hover' => 'background-color: {{VALUE}};',
                        ]
                    ]
                );
    ...
    protected function render() {
        ...
        // ------------------------------------ //
        ?>
        <div class="aiero_video_button_container">
            <div class="aiero_video_button_widget">
                <?php 
                            ...
                            <div <?php $this->print_render_attribute_string( 'image-overlay' ); ?>>
                                <div class="elementor-custom-embed-play" role="button">
                                    ...
                                    <?php
                                        if ($button_text !== '') {
                                            ?>
                                            <span class="aiero_button_text"><?php echo esc_html($button_text); ?></span>
                                            <?php
                                        }                                        
                                    ?>
                                    <span class="elementor-screen-only"><?php echo ($button_text !== '' ? esc_html($button_text) : esc_html__('Watch video', 'aiero_plugin')); ?></span>
                                </div>
                            </div>
                        </div>
                    <?php }
